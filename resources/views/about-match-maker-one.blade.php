                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="flex-row row">
                                ...
                                <p> MatchMaking1 built the Match Maker One app as a Free app. This SERVICE is provided
                                    by MatchMaking1 at no cost and is intended for use as is.
                                </p>
                                ...
                                <p>The terms used in this Privacy Policy have the same meanings as in our Terms and
                                    Conditions, which is accessible
                                    at Match Making One unless otherwise defined in this Privacy Policy.
                                </p>
                                <p><strong>Information Collection and Use</strong></p>
                                <p>For a better experience, while using our Service, we may require you to provide us
                                    with certain
                                    personally identifiable information, including but not limited to Name, date of
                                    birth, location. The information that we request is will be retained by us and used
                                ...
                                <p> We want to inform you that whenever you use our Service, in a case of an
                                    error in the app we collect data and information (through third party products) on
                                    your phone
                                ...
                                <p>Cookies are files with a small amount of data that are commonly used as anonymous
                                    unique identifiers. These
                                    are sent to your browser from the websites that you visit and are stored on your
                                ...
                                <p> We value your trust in providing us your Personal Information, thus we are striving
                                    ...
                                    the internet, or method of electronic storage is 100% secure and reliable, and we
                                    cannot guarantee
                                ...
                                <p>This Service may contain links to other sites. If you click on a third-party link,
                                    ...
                                    to that site. Note that these external sites are not operated by us. Therefore, we
                                    strongly
                                ...
                                <p>This is a match making app made for educational purposes.</p>
                            </div>
                            <!-- /.flex-row  -->
                        </div>
                        <!-- /.container  -->
